...
```
mkdir ~/ankit-csye-6225
cd ~/ankit-csye-6225
git clone git@github.com:Ankit191096/webapp.git
```
...
The port number is 8090.
```
mvn spring-boot:run
```

(4) Testing the service APIs manually (using Postman): In postman, send a ``GET`` request to ``http://localhost:8090/healthz`` and verify the response
